...
from adapter import MerciBenchAdapter
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Convert merci benchmark tasks into Harbor task directories."
    )
    parser.add_argument(
        "--output-dir",
        type=Path,
        default=None,
        help=f"Output directory (default: {HARBOR_DATASETS_DIR / 'merci-bench'})",
    )
    parser.add_argument(
        "--benchmark-dir",
        type=Path,
        default=None,
        help="Path to merci benchmark/ directory (default: auto-detect)",
    )
    parser.add_argument(
        "--limit",
        type=int,
    ...
    output_dir = args.output_dir or (HARBOR_DATASETS_DIR / "merci-bench")

    adapter = MerciBenchAdapter(
        task_dir=output_dir,
