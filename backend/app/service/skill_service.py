...
SKILLS_ROOT = Path.home() / ".merci" / "skills"
SKILL_FILE = "SKILL.md"
EXAMPLE_SKILLS_ENV = "MERCI_EXAMPLE_SKILLS_DIR"
EXAMPLE_SKILL_MARKER = ".merci-example-skill"
...
def skill_import_zip(
    ...
    temp_dir = Path(tempfile.mkdtemp(prefix="merci-skill-extract-"))
    try:
        SKILLS_ROOT.mkdir(parents=True, exist_ok=True)
