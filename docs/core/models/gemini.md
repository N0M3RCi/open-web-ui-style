---
title: Gemini
description: This guide walks you through setting up your Google Gemini API key within Nova to enable the Gemini model for your AI workforce.
---
...
- Once saved, the **"Set as Default"** button on the Gemini Config card will be
  selected/active.
- **You are ready to go.** Your Nova agents can now utilize the Gemini model.
