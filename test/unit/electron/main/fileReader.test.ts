  ...
  describe('Project Management', () => {
    ...
    describe('Project Structure Creation', () => {
      it('should create project directory structure', () => {
        ...
        const expectedPath = '/home/test/nova/test/project_xyz123';
    ...
    describe('Project-based Task Organization', () => {
      ...
      it('should fall back to legacy structure when task not found in projects', () => {
        ...
        if (!hasProjectStructure) {
          ...
          const legacyPath = `/home/user/nova/user/task_${taskId}`;
      ...
      it('should handle task lookup with project ID provided', () => {
        ...
        const projectBasedPath = `/home/user/nova/user/project_${projectId}/task_${taskId}`;
        expect(projectBasedPath).toBe(
          '/home/user/nova/user/project_xyz/task_task123'
        );
      });
    });
    ...
    describe('Task Migration', () => {
      it('should move task from legacy to project structure', () => {
        ...
        const sourcePath = `/home/user/nova/user/task_${taskId}`;
        const destPath = `/home/user/nova/user/project_${projectId}/task_${taskId}`;
        ...
        if (fs.existsSync(sourcePath)) {
          const projectDir = `/home/user/nova/user/project_${projectId}`;
        ...
        expect(mockMkdirSync).toHaveBeenCalledWith(
          `/home/user/nova/user/project_${projectId}`,
          { recursive: true }
        );
      ...
      it('should handle log files during task migration', () => {
        ...
        const sourceLogPath = `/home/.nova/user/task_${taskId}`;
        const destLogPath = `/home/.nova/user/project_${projectId}/task_${taskId}`;
        ...
        const destLogDir = `/home/.nova/user/project_${projectId}`;
        ...
        const mockProjects = [
          {
            id: 'xyz',
            name: 'Project xyz',
            path: '/home/nova/user/project_xyz',
            taskCount: 5,
          ...
          },
          {
            id: 'abc',
            name: 'Project abc',
            path: '/home/nova/user/project_abc',
            taskCount: 3,
    ...
    describe('Backward Compatibility', () => {
      ...
      it('should maintain existing directory structure for legacy tasks', () => {
        ...
        const legacyPath = `/home/nova/test/task_${taskId}`;

        // Should still be able to access legacy paths
        expect(legacyPath).toBe('/home/nova/test/task_existing123');
      });
